...
<html>
    ...
    <body>
        ...
        <div class="container">  
        <form id="contact" action="/upload_special_work_equipments" method="post" enctype="multipart/form-data">
            @csrf
            <h4> שינוי נתונים </h4>
                    ...
                    @foreach($planet as $i)
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                <div class="card-body">                                
                                    <img src="{{asset('uploads/work_equipments/'.$planet->image)}}" class="planets_img">
