...
<html>
    ...
    <body>
        ...
        <div class="container">  
        <form id="contact" action="/upload_gift" method="post" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="{{url('/delete_gift/'.$i->id)}}" class="btn btn-sm btn-outline-danger">מחיקה</a>
                                            <a href="{{url('/edit_gift_by_admin/'.$i->id)}}" class="btn btn-sm btn-outline-warning">עריכה</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
