...
<html>
    ...
    <body>
        ...
        <div class="container">  
        <form id="contact" action="/upload_work_equipment" method="post" enctype="multipart/form-data">
            @csrf
            <h4>הוספת כלי עבודה חדש </h4>
            <fieldset>
                            ...
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="{{url('/delete_work_equipments/'.$i->id)}}" class="btn btn-sm btn-outline-danger">מחיקה</a>
                                            <a href="{{url('/edit_equipment_by_admin/'.$i->id)}}" class="btn btn-sm btn-outline-warning">עריכה</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
