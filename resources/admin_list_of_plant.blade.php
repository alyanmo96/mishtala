...
<html>
    ...
    <body>
        ...
        <div class="container">  
        <form id="contact" action="/upload_plant" method="post" enctype="multipart/form-data">
            @csrf
            <h4>הוספת צמח חדשה</h4>
            <fieldset>
            ...
            <fieldset>
            <label for="type">בחר סוג הצמח</label>
            <select id="type" name="type">
                <option value="1">צמחי_מאכל_ותבלין</option>
                <option value="2">עצי פרי ועצי נוי</option>
                <option value="3">קקטוסים_וסוקולנטים</option>
                <option value="4">צמחי_בית_ומשרד</option>
                <option value="5">סחלבים</option>
                <option value="6">צמחי גינה ומרפסת</option>
                <option value="7">מטפסים ושיחים</option>
            </select>
            </fieldset>
                            ...
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="{{url('/delete_plant/'.$i->id)}}" class="btn btn-sm btn-outline-danger">מחיקה</a>
                                            <a href="{{url('/edit_product_by_admin/'.$i->id)}}" class="btn btn-sm btn-outline-warning">עריכה</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
