  ...
  <body>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>  
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            @if (\Request::is('gifts')) 
              <li class="p-2 text-dark"><a class="nav-link" href="{{ url('gifts') }}" style="display: none;"> מתנות ודברים מיוחדים <span class="sr-only"></span></a></li>
            @else
              <li class="p-2 text-dark"><a class="nav-link" href="{{ url('gifts') }}"> מתנות ודברים מיוחדים <span class="sr-only"></span></a></li>

            @endif

            @if (\Request::is('boxs')) 
              <li class="p-2 text-dark"><a class="nav-link" href="{{ url('boxs') }}" style="display: none;"> כדים <span class="sr-only"></span></a></li>
            @else
              <li class="p-2 text-dark"><a class="nav-link" href="{{ url('boxs') }}">  כדים<span class="sr-only"></span></a></li>
            ...
            @if (\Request::is('')) 
              <li class="p-2 text-dark"><a class="nav-link" href="{{ url('grass') }}" style="display: none;">   דשא סינטטי וחיפוי קרקע<span class="sr-only"></span></a></li>
            @else
              <li class="p-2 text-dark"><a class="nav-link" href="{{ url('grass') }}">  דשא סינטטי וחיפוי קרקע <span class="sr-only"></span></a></li>

            @endif
            
            
            @if (\Request::is('works')) 
              <li class="p-2 text-dark"><a class="nav-link" href="{{ url('works') }}" style="display: none;">  תכנון והקמת גינות <span class="sr-only"></span></a></li>
            @else
              <li class="p-2 text-dark"><a class="nav-link" href="{{ url('works') }}">  תכנון והקמת גינות <span class="sr-only"></span></a></li>
