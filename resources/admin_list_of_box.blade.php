...
<html>
    ...
    <body>
        ...
        <div class="container">  
        <form id="contact" action="/upload_box" method="post" enctype="multipart/form-data">
            @csrf
            <h4>הוספת עציצים ואדניות חדשה</h4>
            <fieldset>
            ...
            <fieldset>
            <label for="type">בחר סוג הכדי</label>
            <select id="type" name="type">
                <option value="1">כדים בטון וחרס</option>
                <option value="2">עציצים ואדניות פלסטיק</option>
                <option value="3">עציצים וכדים מיוחדים</option>
            </select>
            </fieldset>
                            ...
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="{{url('/delete_box/'.$i->id)}}" class="btn btn-sm btn-outline-danger">מחיקה</a>
                                          
                                            <a href="{{url('/edit_box_by_admin/'.$i->id)}}" class="btn btn-sm btn-outline-warning">עריכה</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
